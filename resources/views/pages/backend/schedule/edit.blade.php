...
@section('content')
    ...
    <div class="container-xxl" id="kt_content_container">
        ...
        <form id="form_input" class="form d-flex flex-column flex-lg-row"
            data-kt-redirect="{{ route('backend.schedule.index') }}"
            action="{{ route('backend.schedule.update', $schedule->id) }}" method="PUT">
            <!--begin::Main column-->
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">
                            <h3 class="card-label">Edit Schedule</h3>
                        </div>
                    </div>
                    <div class="card-body p-5">
                        ...
                        <div class="fv-row mb-7 fv-plugins-icon-container">
                            ...
                            <input type="text" class="form-control form-control-lg form-control-solid" name="title"
                                placeholder="Title" value="{{ $schedule->title }}" />
                            <!--end::Input-->
                            <div class="fv-plugins-message-container invalid-feedback"></div>
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="fv-row mb-7 fv-plugins-icon-container">
                            ...
                            <input type="text" class="form-control form-control-lg form-control-solid" name="start"
                                placeholder="Start" value="{{ $schedule->start }}" />
                            <!--end::Input-->
                            <div class="fv-plugins-message-container invalid-feedback"></div>
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="fv-row mb-7 fv-plugins-icon-container">
                            ...
                            <input type="text" class="form-control form-control-lg form-control-solid" name="end"
                                placeholder="End" value="{{ $schedule->end }}" />
                            <!--end::Input-->
                            <div class="fv-plugins-message-container invalid-feedback"></div>
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="fv-row mb-7 fv-plugins-icon-container">
                            ...
                            <input type="text" class="form-control form-control-lg form-control-solid" name="room"
                                placeholder="Room" value="{{ $schedule->room }}" />
                            <!--end::Input-->
                            <div class="fv-plugins-message-container invalid-feedback"></div>
                        </div>
                    </div>
