...
@section('breadcrumb')
    ...
    <ul class="breadcrumb fw-semibold fs-8 my-1">
        ...
        <li class="breadcrumb-item text-muted">Add Member</li>
    </ul>
    <!--end::Breadcrumb-->
@endsection
@section('content')
    ...
    <div class="container-xxl" id="kt_content_container">
        <form id="form_input" class="form d-flex flex-column flex-lg-row"
            data-kt-redirect="{{ route('backend.member.index') }}" action="{{ route('backend.member.store') }}"
            method="POST">
            <!--begin::Aside column-->
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <input type="text" name="family" class="form-control mb-2"
                                placeholder="Enter Beautiful Family" />
                            <!--end::Input-->
                            <!--begin::Description-->
