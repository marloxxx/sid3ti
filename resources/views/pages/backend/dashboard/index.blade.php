            ...
            <div class="col-xl-4 mb-xl-10">
                ...
                <div class="card card-flush h-xl-100">
                    ...
                    <div class="card-header rounded bgi-no-repeat bgi-size-cover bgi-position-y-top bgi-position-x-center align-items-start h-250px"
                        style="background-image:url('../backend/media/svg/shapes/top-green.png" data-bs-theme="light">
                        <!--begin::Title-->
            ...
            <div class="col-xl-8 mb-5 mb-xl-10">
                ...
                <div class="card border-transparent" data-bs-theme="light" style="background-color: #1C325E;">
                    ...
                    <div class="card-body d-flex ps-xl-15">
                        ...
                        <!--begin::Wrapper-->
                        <!--begin::Illustration-->
                        <img src="../backend/media/illustrations/sigma-1/17-dark.png"
                            ...
                            <div class="tab-pane active" id="kt_timeline_widget_1_tab_day" role="tabpanel"
                                ...
                                <div class="table-responsive pb-10">
                                    ...
                                    <div id="kt_timeline_widget_1_1" class="vis-timeline-custom h-350px min-w-700px"
                                        data-kt-timeline-widget-1-image-root="../backend/media/"></div>
                                    <!--end::Timeline-->
                                </div>
                            </div>
                            <!--end::Tab pane-->
                    ...
                    <div class="card-body pt-5">
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center me-3">
                                <!--begin::Logo-->
                                <img src="../backend/media/svg/brand-logos/laravel-2.svg" class="me-4 w-30px"
                                    alt="" />
                                <!--end::Logo-->
                                <!--begin::Section-->
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center me-3">
                                <!--begin::Logo-->
                                <img src="../backend/media/svg/brand-logos/vue-9.svg" class="me-4 w-30px" alt="" />
                                <!--end::Logo-->
                                <!--begin::Section-->
                                <div class="flex-grow-1">
                                    <!--begin::Text-->
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center me-3">
                                <!--begin::Logo-->
                                <img src="../backend/media/svg/brand-logos/bootstrap5.svg" class="me-4 w-30px"
                                    alt="" />
                                <!--end::Logo-->
                                <!--begin::Section-->
                                <div class="flex-grow-1">
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center me-3">
                                <!--begin::Logo-->
                                <img src="../backend/media/svg/brand-logos/angular-icon.svg" class="me-4 w-30px"
                                    alt="" />
                                <!--end::Logo-->
                                <!--begin::Section-->
                                <div class="flex-grow-1">
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center me-3">
                                <!--begin::Logo-->
                                <img src="../backend/media/svg/brand-logos/spring-3.svg" class="me-4 w-30px"
                                    alt="" />
                                <!--end::Logo-->
                                <!--begin::Section-->
                                <div class="flex-grow-1">
                        ...
                        <div class="d-flex flex-stack">
                            ...
                            <div class="d-flex align-items-center me-3">
                                <!--begin::Logo-->
                                <img src="../backend/media/svg/brand-logos/typescript-1.svg" class="me-4 w-30px"
                                    alt="" />
                                <!--end::Logo-->
                                <!--begin::Section-->
                                <div class="flex-grow-1">
