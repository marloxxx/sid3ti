    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="{{ route('backend.dashboard') }}" class="d-lg-none">
                <img alt="Logo" src="{{ asset('backend/media/logos/demo4-mobile.svg') }}" class="h-25px" />
            </a>
        </div>
        <!--end::Mobile logo-->
        <div class="d-flex align-items-center" id="kt_header_wrapper">
            ...
            <div class="page-title d-flex flex-column align-items-start justify-content-center flex-wrap me-lg-20 pb-5 pb-lg-0"
                ...
                <!--begin::Heading-->
                <h1 class="text-dark fw-bold my-1 fs-3 lh-1">Sistem Informasi D3 Teknologi Informasi 2021</h1>
                <!--end::Heading-->
                @yield('breadcrumb')
            </div>
            <!--end::Page title=-->
